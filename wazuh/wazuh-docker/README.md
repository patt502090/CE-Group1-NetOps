...
* **Podman** installed (`podman`)
* **podman-compose** installed (`pip install podman-compose`)
* `vm.max_map_count=262144` (for Wazuh Indexer)

## Documentation

* [Wazuh full documentation](http://documentation.wazuh.com)
* [Wazuh documentation for containers](https://documentation.wazuh.com/current/docker/index.html)
