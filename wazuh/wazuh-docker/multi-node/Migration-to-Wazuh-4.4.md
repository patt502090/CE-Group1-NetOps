...
`podman-compose -f production-cluster.yml stop`
...
`podman-compose -f production-cluster.yml down`

**Steps 5 and 6 can be done with the volume-migrator.sh script, specifying Podman compose version and project name as parameters.**
